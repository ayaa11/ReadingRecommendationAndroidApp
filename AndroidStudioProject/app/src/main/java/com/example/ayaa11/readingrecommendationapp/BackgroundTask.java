...
public class BackgroundTask extends AsyncTask<String, Void, String> {
    ...
    protected String doInBackground(String... params) {
        String reg_url = "http://ayaa11.brighton.domains/ayaa11_ReadingApp/register.php";
        String login_url = "http://ayaa11.brighton.domains/ayaa11_ReadingApp/login.php";
